...
const Testimonials = () => {
  ...
  return (
    <section className="section bg-gradient-to-br from-brandgreen-800 to-brandgreen-900">
      <div className="container mx-auto">
        <div className="text-center mb-16">
          <h2 className="section-title gradient-title">
            What Our Community Says
          </h2>
          <div className="w-24 h-1 bg-brandgreen-400 mx-auto mt-4 mb-6" />
          <p className="text-brandgreen-100 text-lg max-w-2xl mx-auto">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-brandgreen-100 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-32 h-32 opacity-5">
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                className="w-full h-full text-brandgreen-400"
              >
            ...
            <div className="relative z-10">
              <div className="flex flex-col lg:flex-row items-center gap-8">
                ...
                <div className="flex-1 text-center lg:text-left">
                  <blockquote className="text-lg md:text-xl text-brandgreen-900 italic mb-6 leading-relaxed">
                    "{testimonialsData[currentIndex].text}"
                  </blockquote>

                  <div className="border-t border-brandgreen-200 pt-6">
                    <h4 className="font-bold text-xl text-brandgreen-900 mb-1">
              ...
              {testimonialsData.map((_, index) => (
                <button
                  ...
                  className={`w-3 h-3 rounded-full transition-all duration-300 ${
                    index === currentIndex
                      ? "bg-brandgreen-500 scale-125 shadow-md"
                      : "bg-brandgreen-200 hover:bg-brandgreen-300"
                  }`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
            ...
            <div className="text-center p-6 bg-white rounded-2xl shadow-xl border border-brandgreen-100">
              ...
              <div className="text-brandgreen-700">Community Support</div>
            </div>
          </div>
        </div>
      </div>
