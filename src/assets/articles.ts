export const articles = [
  ...
  // },
  {
    id: "food-as-medicine-young-joints",
    title: "FOOD AS MEDICINE FOR YOUNG JOINTS",
    statusColor: "bg-cyan-500",
    description: "How the Right Diet Can Support Children Living with Arthritis",
    details: `Nutrition is not just food—it's medicine. Let Ms. Christine (Clinical Dietitian) show you how diet can ease arthritis in children.\n\nThis Twitter Space held on July 23rd, 2025 from 6:30 PM to 7:30 PM EAT explored practical, evidence-informed dietary strategies that support pediatric joint health, reduce inflammation, and promote overall wellbeing. Participants learned actionable tips caregivers can implement immediately.`,
    image: "/activities/july_x_space.jpeg",
    status: "Recording Available",
    link: "https://x.com/i/spaces/1ZkKzYXoLdexv", // TODO: replace with actual recording URL if available
    altText: "Food as Medicine For Young Joints Twitter Space",
    badgeColor: "bg-blue-500",
    date: "2025-07-23",
  },
  {
    id: 'little-joints-big-challenges-twitter-space',
    title: 'LITTLE JOINTS, BIG CHALLENGES',
    statusColor: 'bg-cyan-500',
    description:
      'A Deep Dive into Managing Arthritis in Children and Supporting their Mental Health',
    details: `The Twitter Space held on June 25th, 2025 from 6:30 to 7:30 PM EAT features Dr. Angela Migowa (C.E.O & Founder, Hope Arthritis Foundation, Kenya) as moderator, with guest speaker Professor Mohammed Hassan (Associate Professor of Rheumatology, Tanta University, Egypt). This session provides a comprehensive exploration of managing arthritis in children while addressing their mental health needs.`,
    image: '/activities/june_x_space.png',
    status: 'Recording Available',
    link: 'https://x.com/i/spaces/1MnxnwEVedkKO',
    badgeColor: 'bg-blue-500',
    date: '2025-06-25',
  },
  {
    id: 'lupus-unchained-twitter-space',
    title: 'LUPUS UNCHAINED',
    statusColor: 'bg-cyan-500',
    description:
      'A Powerful Conversation on Awareness, Advocacy and Living Fully with Lupus',
    details: `The Twitter Space held on May 28th, 2025 from 6:30 to 7:30 PM EAT features Dr. Angela Migowa (CEO & Founder, Hope Arthritis Foundation) as moderator, with guest speakers Ms. Emma Halm (Executive Director, Oyemam Autoimmune Foundation) and Dr. Raffaella Carlomagno (Pediatric Rheumatologist, CHUV, Switzerland). This powerful conversation focuses on lupus awareness, advocacy, and living fully with the condition.`,
    image: '/activities/may_x_space.png',
    status: 'Recording Available',
    link: 'https://x.com/i/spaces/1gqxvjYrnalxB',
    altText: 'Lupus Unchained Twitter Space',
    badgeColor: 'bg-blue-500',
    date: '2025-05-28',
  },
  ...
  {
    id: "leveling-up-transition-care",
    title: "Leveling Up: Why Transition Care Matters in Rheumatology",
    statusColor: "bg-orange-500",
    description:
      "Join Dr. Angela Migowa in conversation with Dr. Fer Estevez-Lopez and Rafael Prieto Moreno as they explore the crucial importance of transition care in rheumatology.",
    details: `The Twitter Space held on March 26th, 2025 from 6:30 to 7:30 PM EAT brings together experts to discuss the important topic of transition care in rheumatology. This conversation addresses the challenges young adults face when moving from pediatric to adult rheumatology care and provides practical insights for healthcare providers, patients, and families.`,
    image: "/img/leveling_up.webp",
    status: "Recording Available",
    link: "https://x.com/i/spaces/1mnGegeqEDrxX",
    altText: "Leveling Up Twitter Space",
    badgeColor: "bg-blue-500",
    date: "2025-03-26",
  },
