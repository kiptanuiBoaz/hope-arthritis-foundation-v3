...
const BootcampRegistrationModal: React.FC<BootcampRegistrationModalProps> = ({
  ...
  const paystackProps = {
    ...
    amount: 15600 * 100, // 15600 KES in cents (adjust as needed for your Paystack config)
    currency: "KES",
    metadata: {
        ...
        {step === "registration" ? (
            ...
            <form onSubmit={handleProceedToPayment} className="space-y-4">
              ...
              <div className="pt-2">
                ...
                <div className="p-3 bg-gray-50 border border-gray-200 rounded-lg">
                  <p className="font-medium">KSH 15600 / USD 120</p>
                </div>
              </div>
          ...
          <>
            ...
            <div className="bg-gray-50 p-6 rounded-xl flex flex-col items-center">
              ...
              <h6 className="text-md font-sans pb-4">Amount: Ksh 15600</h6>
