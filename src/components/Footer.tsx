      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              <svg
                className="fill-current h-12 w-32 mr-2"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 435.28 151.87"
              >
                <defs>
                  <style>
                    {`.cls-1{fill:#70a553;}
                ...
                <g id="Layer_2" data-name="Layer 2">
                  <g id="Layer_1-2" data-name="Layer 1">
                    <path
                      className="cls-1"
                      d="M23.67,88.88a91.72,91.72,0,0,0-3.86,13.33q.11,3.35.26,6.52a95.43,95.43,0,0,0,13.34-.38l.33-1.5q.82-4.77,1.61-9.45s.25-1.83.8-4.76c.56-3.33,1.12-6.63,1.68-9.86,0,0,4.54-17.91,10.81-23.79-15.53,4.85-22.42,23.14-25,29.89"
                    />
                    <path
                      className="cls-1"
                      d="M32,115.22a81.14,81.14,0,0,1-11.65-1.53c.18,3.55.36,6.94.47,10.13l-3.93.15A10.15,10.15,0,0,1,6.32,113.7c0-1.35,0-2.74.09-4.16-2.51-1-4.66-2-6.41-2.84v45.17H22.51c4.29-12.16,7.06-25.28,9.45-36.65"
                    />
                    <path
                      className="cls-2"
                      d="M68.11,27.26a8.91,8.91,0,0,0,2.1-1.82C74.33,20.54,73,14.17,72.49,13,71.4,10.43,69,9.73,66.58,11.08,62.37,13.45,60,21,62,25.37c1.22,2.61,3.65,3.39,6.11,1.89"
                    />
                    <path
                      className="cls-3"
                      d="M41.56,0A275.43,275.43,0,0,0,24,51.84A162.07,162.07,0,0,0,21,69.1c5.69-8.17,13.55-15.76,23.91-18.31,8.33-2.06,23.62-2.08,30.36,8.61,4.11,6.52,3.19,14.1,1.7,19.31a.38.38,0,0,1-.74-.16c.73-5.81-.74-11.41-4.3-15.38A16.65,16.65,0,0,0,62.38,58a21,21,0,0,0-2.67,2.73A28.18,28.18,0,0,0,57,64.61c-.27.47-.53,1-.79,1.46A44.19,44.19,0,0,0,53,74.48c-.34,1.24-.65,2.52-.92,3.84-.12.41-.24.84-.36,1.28-.23.87-.47,1.77-.71,2.7l-.36,1.4c-.24,1-.48,1.93-.72,2.92-.12.5-.23,1-.35,1.51-.36,1.52-.71,3.07-1.06,4.65-.7,3.15-1.38,6.4-2,9.61-.26,1.31-.52,2.62-.78,3.91,2.3-.54,4.63-1.18,7-1.94A94.39,94.39,0,0,0,82.81,88.23V0ZM70.21,25.44a8.91,8.91,0,0,1-2.1,1.82c-2.46,1.5-4.89.72-6.11-1.89-2-4.38.37-11.92,4.57-14.29C69,9.73,71.4,10.43,72.49,13c.53,1.22,1.84,7.59-2.28,12.49"
                    />
                    <path
                      className="cls-4"
                      d="M52,113.74A75.75,75.75,0,0,1,44.11,115c-.69,3.81-1.3,7.26-1.78,10.1q-.63,3.86-1.27,7.47c-.22,1.21-.44,2.41-.67,3.58a117,117,0,0,1-4,15.77H82.81V99.76a78.58,78.58,0,0,1-30.82,14"
                    />
                    <path
                      className="cls-4"
                      d="M6.5,107.22a229.8,229.8,0,0,1,14.6-72A227.35,227.35,0,0,1,38,0H0V105.8c1.86.47,4,1,6.5,1.42"
                    />
                  </g>
                </g>
              </svg>
            ...
            <div className="text-sm text-gray-300 space-y-2">
              <p>Commodore Office Suites</p>
              <p>Kindaruma Road, Kilimani</p>
              <p>Office Suite 2G</p>
              <p className="text-gray-400">
                Registration Number: OP.218/051/21-382/12509
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-start text-gray-300">
                <svg
                  className="w-4 h-4 mr-2 mt-0.5 text-orange-400"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
