        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div>
            <div className="bg-white p-8 rounded-lg shadow-sm mb-8">
              <h3 className="text-xl font-bold mb-4">A Holistic Intervention to Paediatric Rheumatology</h3>

              <div className="text-gray-600 mb-6">
                <p className="mb-2">Hurlingham Park Building, Office Suite B6, 3rd Floor Off Argwings Kodhek Road, Hurlingham.</p>
            ...
            <div className="bg-orange-50 p-8 rounded-lg shadow-sm">
              <h3 className="font-bold text-lg mb-4">Support Our Fight Against Childhood Arthritis</h3>
              <p className="text-gray-700 mb-4">
                Help us fund research and provide care for those suffering from arthritis. Your support makes a difference.
              </p>
