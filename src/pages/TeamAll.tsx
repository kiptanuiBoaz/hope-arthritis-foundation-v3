    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 to-orange-50/30 min-h-screen">
      <div className="container mx-auto py-12">
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-800 mb-4 gradient-title">
            Meet Our Team
          </h2>
          <div className="w-24 h-1 bg-orange-500 mx-auto mb-6" />
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Our dedicated panel of experts working together to improve the lives
            of children with arthritis and other rheumatic diseases across
            Africa and beyond.
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-orange-500 to-blue-500 rounded-2xl p-8 text-white text-center shadow-xl max-w-4xl mx-auto">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg mb-6 opacity-90">
              Interested in contributing to our cause? We welcome passionate
              professionals who want to make a difference in pediatric
              rheumatology.
            </p>
