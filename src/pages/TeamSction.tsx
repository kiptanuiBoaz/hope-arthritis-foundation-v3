  ...
  return (
    <section id="team" className="section bg-white">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold text-gray-800 mb-2 gradient-title">
          Our Team
        </h1>
        ...
        <div className="flex justify-center mt-12">
          <a
            href="/team"
            className="bg-orange-500 hover:bg-orange-600 text-white font-medium py-3 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 text-lg inline-flex items-center"
          >
        ...
        <div className="mt-16 bg-orange-50 rounded-2xl p-8 shadow-lg">
          <div className="flex flex-col md:flex-row items-center gap-6">
            <div className="md:w-1/2">
              <h3 className="text-2xl font-bold mb-4 gradient-title">
                Join Our Team
              </h3>
