      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12 mt-10">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            designed to help patients and families better understand and manage
            childhood arthritis and other rheumatic conditions.
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-orange-500 to-blue-500 rounded-2xl p-8 text-white text-center shadow-xl">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg mb-6 opacity-90">
              ...
              access the information and resources you need.
            </p>
