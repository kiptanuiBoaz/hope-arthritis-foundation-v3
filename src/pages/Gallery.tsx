    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 to-orange-50/30 min-h-screen">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h1 className="mt-8 text-4xl md:text-5xl font-bold gradient-title mb-4">
            Gallery
          </h1>
          <div className="w-24 h-1 bg-orange-500 mx-auto mb-6" />
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Explore our collection of memorable moments from events, workshops,
            and activities that showcase our commitment to advancing pediatric
            rheumatology care.
          </p>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-orange-500 to-blue-500 rounded-2xl p-8 text-white text-center shadow-xl">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg mb-6 opacity-90">
              Stay connected with our community and be part of our mission to
              advance pediatric rheumatology care.
            </p>
